...
public class BuildVars {
    ...
    // PR #30738 fork: put YOUR OWN api_id and api_hash here (from https://my.telegram.org)
    // Do NOT commit real credentials — Telegram auto-bans leaked api_hash.
    public static int APP_ID = 0;
    public static String APP_HASH = "YOUR_API_HASH_FROM_MY_TELEGRAM_ORG";
